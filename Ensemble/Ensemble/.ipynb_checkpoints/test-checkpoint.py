...
if __name__ == "__main__":
    ...
    with open(arg.TEGCN_B_3d, 'rb') as r17:
        r17 = list(pickle.load(r17).items())

    with open(arg.TEGCN_BM_3d, 'rb') as r18:
        r18 = list(pickle.load(r18).items())

    with open(arg.TEGCN_J_3d, 'rb') as r19:
        r19 = list(pickle.load(r19).items())

    with open(arg.TEGCN_JM_3d, 'rb') as r20:
        r20 = list(pickle.load(r20).items())

    with open(arg.InfoGCN_Angle_3d, 'rb') as r21:
        r21 = list(pickle.load(r21).items())

    with open(arg.InfoGCN_JM_3d, 'rb') as r22:
        r22 = list(pickle.load(r22).items())

    with open(arg.InfoGCN_k1_3d, 'rb') as r23:
        r23 = list(pickle.load(r23).items())

    with open(arg.InfoGCN_loss_3d, 'rb') as r24:
        r24 = list(pickle.load(r24).items())

    with open(arg.Sttformer_Angle_3d, 'rb') as r25:
        r25 = list(pickle.load(r25).items())

    with open(arg.Sttformer_B_3d, 'rb') as r26:
        r26 = list(pickle.load(r26).items())

    with open(arg.Sttformer_J_3d, 'rb') as r27:
        r27 = list(pickle.load(r27).items())

    with open(arg.Sttformer_JM_3d, 'rb') as r28:
        r28 = list(pickle.load(r28).items())

    space = [(0.2, 1.2) for i in range(28)]
